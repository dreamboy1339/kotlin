 ...
 * Customization equality relation for value classes is currently considered as an experimental feature. The value class declaring typed
 * equals must be annotated by [AllowTypedEquals] annotation.
 */
